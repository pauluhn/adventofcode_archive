...
class aoc2019Tests: XCTestCase {
    ...
    func testDay14Part2() {
        let testData3 = testDataDay14c().newlineSplit()
        assert(Y2019Day14.Part2(testData3) == 82892753)
        
        let testData4 = testDataDay14d().newlineSplit()
        assert(Y2019Day14.Part2(testData4) == 5586022)
        
        let testData5 = testDataDay14e().newlineSplit()
        assert(Y2019Day14.Part2(testData5) == 460664)
        
        let answer = Y2019Day14.Part2(readInput(year: year, day: 14))
        print("\(#function):\(answer)")
    ...
    func testDay16Part2() { // 77s
        assert(Y2019Day16.Part2("03036732577212944063491565474664") == "84462026")
        assert(Y2019Day16.Part2("02935109699940807407585447034323") == "78725270")
        assert(Y2019Day16.Part2("03081770884921959731165446850517") == "53553731")

        let answer = Y2019Day16.Part2(readInput(year: year, day: 16).first!)
        print("\(#function):\(answer)")
        assert(answer == "53201602")
    }
    
    func testDay17Part1() {
        let answer = Y2019Day17.Part1(readInput(year: year, day: 17).first!)
        print("\(#function):\(answer)")
        assert(answer == 9876)
    }

    func testDay17Part2() {
        let answer = Y2019Day17.Part2(readInput(year: year, day: 17).first!)
        print("\(#function):\(answer)")
        assert(answer == 1234055)
    }
    
    func testDay19Part1() {
        let answer = Y2019Day19.Part1(readInput(year: year, day: 19).first!, 50)
        print("\(#function):\(answer)")
        assert(answer == 186)
    }
    
    func testDay20Part1() { // ~35s
        let testData1 = testDataDay20a().newlineSplit()
        assert(Y2019Day20.Part1(testData1) == 23)
        let testData2 = testDataDay20b().newlineSplit()
        assert(Y2019Day20.Part1(testData2) == 58)

        let answer = Y2019Day20.Part1(readInput(year: year, day: 20))
        print("\(#function):\(answer)")
        assert(answer == 684)
    }
}
