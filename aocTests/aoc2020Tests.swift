...
class aoc2020Tests: XCTestCase {
    ...
    func testDay24Part2() { // ~220s
        let testData1 = testDataDay24().newlineSplit()
        assert(Y2020Day24.Part2(testData1) == 2208)

        let answer = Y2020Day24.Part2(readInput(year: year, day: 24))
        print("\(#function):\(answer)")
        assert(answer == 3649)
    }
    func testDay25Part1() { // ~9s
        assert(Y2020Day25.Part1(5764801, 17807724) == 14897079)

        let answer = Y2020Day25.Part1(10943862, 12721030)
        print("\(#function):\(answer)")
        assert(answer == 5025281)
    }
